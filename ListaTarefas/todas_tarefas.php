							...
							<div class="col">
								...
								<? foreach ($tarefas as $indice => $tarefa) { ?>
									...
									<div class="row mb-3 d-flex align-items-center tarefa">
										<div class="col-sm-9" id="tarefa_<?=$tarefa[0]?>">
											<?= $tarefa[2] ?> (<?= $tarefa[1] ?>)</div> 
										<div class="col-sm-3 mt-2 d-flex justify-content-between">
											...
											onclick="editar(<?=$tarefa[0]?>,
											'<?=$tarefa[2]?>')"></i>
											<i class="fas fa-check-square fa-lg text-success" onclick="marcarRealizada(<?=$tarefa[0]?>)"></i>
											<? }?>
										</div>
									</div>
