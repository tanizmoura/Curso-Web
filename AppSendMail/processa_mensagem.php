<?php  
    ...
    $mail->Username = 'tanisejogos@gmail.com';                 // SMTP username
    $mail->Password = 'nyancat41094';                           // SMTP password
    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 587;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('tanisejogos@gmail.com', 'Remetente Curso');
    ...
    $mensagem->status['descricao_status'] = 'Mensagem enviada com sucesso!';
    	...
    	$mensagem->status['descricao_status'] = 'Não foi possível enviar o email. Tente novamente mais tarde! Detalhe do erro: ' . $mail->ErrorInfo;
	}
